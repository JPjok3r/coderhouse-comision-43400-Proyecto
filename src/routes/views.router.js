...
router.get('/chat', isLogged, authUserMiddleware(["admin"]), viewController.chat);
...
router.get('/cart/:id', isLogged, authUserMiddleware(["admin"]), viewController.carritoView);
router.get('/recoveryPassword', viewController.recoveryPass);
router.get('/recoverPass/:id', viewController.recoverPassMail);
router.get('/administration', authAdminMiddleware, viewController.adminViews);
